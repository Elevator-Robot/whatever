        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-indigo-600">EDC System</h1>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Create, manage, and analyze your data collection forms with our powerful EDC system. 
            Built with accessibility, reliability, and ease of use in mind.
          </p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            ...
            <p className="text-gray-600">
              Create custom forms with drag-and-drop functionality. Add various field types, validation rules, and conditional logic.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            ...
            <p className="text-gray-600">
              Visualize and analyze collected data with built-in charts, reports, and export capabilities.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            ...
            <p className="text-gray-600">
              Progressive Web App with offline capabilities. Works seamlessly on desktop, tablet, and mobile devices.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            ...
            <p className="text-gray-600">
              Built with security best practices and accessibility standards. WCAG compliant interface.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            ...
            <p className="text-gray-600">
              Instant form validation with helpful error messages and field-level feedback for better user experience.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            ...
            <p className="text-gray-600">
              Share forms and collaborate with team members. Role-based permissions and audit trails included.
            </p>
          </div>
        </div>
        ...
        <div className="bg-indigo-50 rounded-2xl p-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-6">
            Create your first form in minutes and start collecting data efficiently.
          </p>
          <Link
            href="/builder"
